...
We also thank Sergi Delgado Segura, TheCharlatan, Mikhail Kudinov, Sebastian Falbesoner, Adam Gibson, Hennadii Stepanov, Carla Kirk-Cohen, and Abubakar Sadiq Ismail for their contributions and review.
...
\iffull
  ...
  \begin{description}
    \item[2025-09-09]\
          \begin{itemize}
            \item Address feedback from the 2025 Cryptocamp: fix bugs, improve notation, add clarifying explanations and recap quiz.
          \end{itemize}
    \item[2025-08-24]\
          \begin{itemize}
