...
\begin{exercise}\label{ex:pedersen-hiding}
  Argue that Pedersen commitments are perfectly hiding (\autoref{thm:pedersen-hiding}).
\end{exercise}
...
\ifsolutions
\begin{mysolution}
  The discrete logarithm in $\ZZ_p$ where the group operation is addition can be computed in polynomial time.
  In general, quantum computers can solve the DL problem in polynomial time using Shor's algorithm.
\end{mysolution}
\fi
