...
\begin{lemma}\label{lem:schnorr-to-single}
  ...
  \[
    \left|\advantage{Single}{\cdv, \algo{InpGen}} - \advantage{EUF-CMA}{\adv, \algo{SchnorrSig}[\grgen, \algo{H}]}\right| \leq \frac{q_s(q_s + q_h)}{2^{\secpar-1}}
  \]
...
\begin{theorem}[Schnorr signatures are EUF-CMA secure]\label{thm:schnorr-euf-cma}
  ...
  \[
    \advantage{EUF-CMA}{\adv, \algo{SchnorrSig}[\grgen, \algo{H}]} \leq \frac{q_s(q_s + q_h)}{2^{\secpar-1}} + \sqrt{(q_h + 1) \left(\advantage{DLog}{\ddv, \grgen} + \frac{1}{2^{\secpar-1}}\right)}.
  \]
\end{theorem}
...
\begin{mysolution}
  ...
  \[
    \advantage{EUF-CMA}{\adv, \algo{SchnorrSig}} \leq \frac{q_s(q_s + q_h)}{2^{\secpar-1}} + \sqrt{(q_h + 1) \left(\advantage{DLog}{\ddv, \grgen} + \frac{1}{2^{\secpar-1}}\right)}
  \]
  ...
  \[
    \frac{q_s(q_s + q_h)}{2^{\secpar-1}} \approx \frac{2^{10} \cdot 2^{85}}{2^{255}} = \frac{2^{95}}{2^{255}} = 2^{-160}
  \]
  
  Second term:
  \[
    \sqrt{(q_h + 1) \left(\advantage{DLog}{\ddv, \grgen} + \frac{1}{2^{\secpar-1}}\right)} \approx \sqrt{2^{85} \cdot \left(2^{-87} + 2^{-255}\right)} \approx \sqrt{2^{85} \cdot 2^{-87}} = \sqrt{2^{-2}} = 2^{-1} = 0.5
  \]
  
  Therefore:
  \[
    \advantage{EUF-CMA}{\adv, \algo{SchnorrSig}} \leq 2^{-160} + 0.5 \approx 0.5
  \]
...
\begin{mysolution}
  ...
  \[
    \Pr[E] \leq \frac{q_s(q_s + q_h)}{|\GG|} \leq \frac{q_s(q_s + q_h)}{2^{\secpar-1}}
  \]
...
\begin{mysolution}
  ...
  By the forking lemma (noting that $\pcoracle{H}$ maps to $\ZZ_p$ where $|\ZZ_p| = p \geq 2^{\secpar-1}$):
  \begin{align*}
    \advantage{Fork}{\cdv, \algo{InpGen}} &\geq \advantage{Single}{\cdv, \algo{InpGen}} \left( \frac{\advantage{Single}{\cdv, \algo{InpGen}}}{q_h + 1} - \frac{1}{2^{\secpar-1}} \right)\\
    &\geq  \frac{\advantage{Single}{\cdv, \algo{InpGen}}^2}{q_h + 1} - \frac{1}{2^{\secpar-1}}\\
  \end{align*}
  ...
  This means:
  \begin{align*}
    \advantage{EUF-CMA}{\adv, \algo{SchnorrSig}[\grgen, \algo{H}]} - \frac{q_s(q_s + q_h)}{2^{\secpar-1}} &\leq \advantage{Single}{\cdv, \algo{InpGen}}\\
    &\leq \advantage{EUF-CMA}{\adv, \algo{SchnorrSig}[\grgen, \algo{H}]} + \frac{q_s(q_s + q_h)}{2^{\secpar-1}}
  \end{align*}
  
  Therefore:
  \begin{align*}
    \advantage{DLog}{\ddv, \grgen} &\geq \frac{\advantage{Single}{\cdv, \algo{InpGen}}^2}{q_h + 1} - \frac{1}{2^{\secpar-1}}\\
    &\geq \frac{\left(\advantage{EUF-CMA}{\adv, \algo{SchnorrSig}[\grgen, \algo{H}]} - \frac{q_s(q_s + q_h)}{2^{\secpar-1}}\right)^2}{q_h + 1} - \frac{1}{2^{\secpar-1}}
  \end{align*}
  
  Rearranging:
  \[
    (q_h + 1) \left(\advantage{DLog}{\ddv, \grgen} + \frac{1}{2^{\secpar-1}}\right) \geq \left(\advantage{EUF-CMA}{\adv, \algo{SchnorrSig}[\grgen, \algo{H}]} - \frac{q_s(q_s + q_h)}{2^{\secpar-1}}\right)^2
  \]
