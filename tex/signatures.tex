...
\begin{exercise}\label{ex:schnorr-to-single}
  ...
  Hint: Relate $\game{\Game~\algo{EUF-CMA}}{\algo{SchnorrSig}}$ and $\game{\algo{Single}}{\algo{InpGen}}[\bdv]$, then $\game{\algo{Single}}{\algo{InpGen}}[\bdv]$ and $\game{\algo{Single}}{\algo{InpGen}}[\cdv]$.
\end{exercise}
