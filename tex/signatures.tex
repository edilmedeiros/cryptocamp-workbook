...
\begin{theorem}[Schnorr signatures are EUF-CMA secure]\label{thm:schnorr-euf-cma}
  ...
  \[
    \advantage{EUF-CMA}{\adv, \algo{SchnorrSig}[\grgen, \algo{H}]} \leq \frac{2 q_s(q_s + q_h)}{2^\secpar} + \sqrt{(q_h + 1) \left(\advantage{DLog}{\ddv, \grgen} + \frac{1}{2^{\secpar-1}}\right)}.
  \]
\end{theorem}
...
\begin{mysolution}
  ...
  \[
    \advantage{EUF-CMA}{\adv, \algo{SchnorrSig}} \leq \frac{2 q_s(q_s + q_h)}{2^\secpar} + \sqrt{(q_h + 1) \left(\advantage{DLog}{\ddv, \grgen} + \frac{1}{2^{\secpar-1}}\right)}
  \]
  ...
  \[
    \frac{2 q_s(q_s + q_h)}{2^\secpar} \approx \frac{2 \cdot 2^{10} \cdot 2^{85}}{2^{256}} = \frac{2^{96}}{2^{256}} = 2^{-160}
  \]
...
\begin{mysolution}
  ...
  \begin{align*}
    ...
    &\geq \frac{\left(\advantage{EUF-CMA}{\adv, \algo{SchnorrSig}[\grgen, \algo{H}]} - \frac{2 q_s(q_s + q_h)}{2^\secpar}\right)^2}{q_h + 1} - \frac{1}{2^{\secpar-1}}
  \end{align*}
  
  Rearranging:
  \[
    (q_h + 1) \left(\advantage{DLog}{\ddv, \grgen} + \frac{1}{2^{\secpar-1}}\right) \geq \left(\advantage{EUF-CMA}{\adv, \algo{SchnorrSig}[\grgen, \algo{H}]} - \frac{2 q_s(q_s + q_h)}{2^\secpar}\right)^2
  \]
